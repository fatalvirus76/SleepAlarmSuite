    ...
    var palette: ThemePalette {
        ...
        case .glas:
            return ThemePalette(
                ...
                accent: Color(hex: "0E6D86"),
                accent2: Color(hex: "5B49C0"),
                onAccent: Color.white,
                text: Color(hex: "0B1220"),
                textSecondary: Color(hex: "3A4A61"),
                cardTint: Color.white.opacity(0.40),
                stroke: Color(hex: "0B1220").opacity(0.12),
                ringTrack: Color(hex: "0B1220").opacity(0.12),
                chipFill: Color.white.opacity(0.85),
                fieldFill: Color.white.opacity(0.85),
                success: Color(hex: "0F7A5A"),
                warning: Color(hex: "9A6207"),
                danger: Color(hex: "C02A2A"),
                isLight: true
            )
        ...
        case .nord:
            return ThemePalette(
                ...
                accent: Color(hex: "33527A"),
                accent2: Color(hex: "4F6F9C"),
                onAccent: Color.white,
                text: Color(hex: "2E3440"),
                textSecondary: Color(hex: "3D4658"),
                cardTint: Color.white.opacity(0.42),
                stroke: Color(hex: "2E3440").opacity(0.14),
                ringTrack: Color(hex: "2E3440").opacity(0.14),
                chipFill: Color.white.opacity(0.85),
                fieldFill: Color.white.opacity(0.85),
                success: Color(hex: "1F7060"),
                warning: Color(hex: "916107"),
                danger: Color(hex: "B03636"),
                isLight: true
            )
